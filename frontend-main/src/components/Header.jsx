      ...
      <header className="p-3 mb-3 bottom header-container">
        <div className="container">
          <div className="d-flex flex-wrap align-items-center justify-content-between">
            ...
            >
              <h1>
                <span className="quick-text">YatriGhar</span>
              </h1>
            </a>

            {/* Navigation Links */}
            <ul className="nav col-12 col-lg-auto mb-2 justify-content-center mb-md-0" role="navigation" aria-label="Main Navigation">
              <li>
                <Link to="/" smooth="true" duration={500} className="nav-link px-3" aria-label="Home">Home</Link>
              </li>
              <li>
                <ScrollLink to="about" smooth="true" duration={500} className="nav-link px-3" aria-label="About Us">About Us</ScrollLink>
              </li>
              <li>
                <ScrollLink to="service" smooth="true" duration={500} className="nav-link px-3" aria-label="Service">Service</ScrollLink>
              </li>
              <li>
                <ScrollLink to="get-in-touch" smooth="true" duration={100} className="nav-link px-3" aria-label="Contact Us">Contact Us</ScrollLink>
              </li>
              <li>
                <Link to="/hotel" className="nav-link px-3" aria-label="Hotel Packages">Hotel Packages</Link>
              </li>
            </ul>
